gridmetr_download <- 
  function(variables,years,dest.dir="01_data/gridmet/",parallel.workers=1){
    ...
    map(1:dim(file.list)[1],
        function(x){
          ...
          target.file <- str_c(dest.dir,file.list$var[x],"/",file.list$file.name[x])
